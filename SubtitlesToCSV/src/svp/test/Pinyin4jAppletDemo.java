...
public class Pinyin4jAppletDemo extends JApplet
{
    ...
    private JPanel getUnformattedGwoyeuRomatzyhPanel()
    {
        if (unformattedGwoyeuRomatzyhPanel == null)
        {
            ...
            unformattedGwoyeuRomatzyhPanel.add(unformattedGwoyeuRomatzyhLabel, java.awt.BorderLayout.NORTH); // Generated
            unformattedGwoyeuRomatzyhPanel.add(getUnformattedGwoyeuRomatzyhScrollPane(), BorderLayout.CENTER); // Generated
        }
    ...
    private JTabbedPane getJTabbedPane()
    {
        if (jTabbedPane == null)
        {
            ...
            jTabbedPane.addTab("Unformatted Chinese Romanization Systems", null, getUnformattedCharPanel(), null); // Generated
    ...
    private JButton getConvertButton()
    {
        if (convertButton == null)
        {
            ...
            convertButton.addActionListener(new java.awt.event.ActionListener()
            {
                ...
                {
                    unformattedHanyuPinyinTextArea.setText(concatPinyinStringArray(PinyinHelper.toHanyuPinyinStringArray(chineseCharacter)));
                    unformattedTongyongPinyinTextArea.setText(concatPinyinStringArray(PinyinHelper.toTongyongPinyinStringArray(chineseCharacter)));
                    unformattedWadePinyinTextArea.setText(concatPinyinStringArray(PinyinHelper.toWadeGilesPinyinStringArray(chineseCharacter)));
                    unformattedMPS2PinyinTextArea.setText(concatPinyinStringArray(PinyinHelper.toMPS2PinyinStringArray(chineseCharacter)));
                    unformattedYalePinyinTextArea.setText(concatPinyinStringArray(PinyinHelper.toYalePinyinStringArray(chineseCharacter)));
                    unformattedGwoyeuRomatzyhTextArea.setText(concatPinyinStringArray(PinyinHelper.toGwoyeuRomatzyhStringArray(chineseCharacter)));
                }
                 ...
                 * @param caseSelection
                 */
                private void updateFormattedTextField(char chineseCharacter,
                        String toneSelection, String vcharSelection,
